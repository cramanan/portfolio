...
type Tech = { title: string; d: string };
...
export default function Index() {
    ...
    return (
        <>
            ...
            <header className="sticky z-50 top-0 h-10 rounded-2xl">
                <div className="h-full flex items-center justify-between">
                    <span />
                    <nav
                        className={`flex gap-2 font-medium text-lg ${asapItalic.className}`}
                    >
                        <a href="#">{t("home")}</a>
            ...
            <section className="flex pt-10 flex-col items-center">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <p className="p-5">
                        ...
                        Reiciendis minima inventore?
                        <a
                            href="#"
                            target="_blank"
                            className="block underline px-1 text-center"
                        >
                            {t("cv")}.
                        </a>
                    </p>
            ...
            <section id="skills" className="h-screen pt-10">
                <h2 className={`${asapItalic.className} text-center text-3xl`}>
                    {t("skills.title")}
                </h2>
                <div>
                    {Object.keys(techs).map((tech, idx) => (
                        <div key={idx}>
                            ...
                            <p>
                                ...
                                adipisicing elit. Quod pariatur earum
                                reprehenderit.
                            </p>
                            <ul className="flex justify-evenly p-3">
                                {techs[tech].map(({ title, d }) => (
                                    <li
                                        key={title}
                                    ...
                                    >
                                        <div className="flex h-full justify-center">
                                            <svg
                                                ...
                                                width={48}
                                                height={48}
                                                className="h-12 w-12 fill-foreground"
            ...
            >
                ...
                <p className="text-center p-2">{t("contact.description")}:</p>
                <div className="flex flex-col items-center gap-2">
                    ...
                    >
                        ...
                        <span>cramananjaonapro@gmail.com</span>
                    </div>
                </div>
            </section>
            <footer>
                <div className="text-center py-1">
                    Cyril Ram. © 2024 | {t("copyrights")}
                </div>
            </footer>
        </>
    );
